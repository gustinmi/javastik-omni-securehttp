...
public class CreateSignature extends CreateSignatureBase {
	...
	public static void main(String[] args) throws IOException, GeneralSecurityException {
		...
		char[] password = "s!tartablaT5".toCharArray(); // TODO use Java 6
		                                         // java.io.Console.readPassword
		keystore.load(new FileInputStream(new File("c:\\Users\\gustin\\ks")), password);

		// sign PDF
		CreateSignature signing = new CreateSignature(keystore, password);
		signing.setExternalSigning(externalSig);

		File inFile = new File("C:\\Users\\gustin\\workspace\\cryptotest\\src\\main\\resources\\test123.pdf");
